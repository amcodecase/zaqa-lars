...
<!--            --><?php //if ($currentUser): ?>
<!--                <p>Managing users as <strong>--><?php //echo htmlspecialchars($currentUser['first_name'] . ' ' . $currentUser['last_name']); ?><!--</strong></p>-->
<!--            --><?php //endif; ?>
        </div>
                ...
                <?php if (!empty($newUsers)): ?>
                    ...
                    <div class="content-grid">
                        <?php foreach (array_slice($newUsers, 0, 6) as $user): ?>
                            <div class="stat-card" data-user-id="<?php echo $user['id']; ?>">
