...
function searchTevetaRecords($pdo, $searchTerm, $searchType) {
    $records = [];
    $totalCount = 0;
    ...
    try {
        ...
        $countQuery = "SELECT COUNT(*) as total FROM teveta_data WHERE {$whereClause}";
        ...
        $query = "
            SELECT td.*, i.name as institution_name 
            FROM teveta_data td
            LEFT JOIN institutions i ON td.institution_id = i.id
            WHERE {$whereClause}
        ...
        error_log("Error searching TEVETA records: " . $e->getMessage());
...
if (isset($_POST['search']) && !empty($_POST['search_term']) && !empty($_POST['search_type'])) {
    ...
    $searchResults = searchTevetaRecords($pdo, $searchTerm, $searchType);
...
<head>
    ...
    <title>View TEVETA Records - Zambia Qualifications Authority</title>
...
<div class="dashboard-container">
    ...
    <main class="dashboard-content">
        ...
        <div class="dashboard-card">
            <h3><i class="fas fa-search"></i> Search TEVETA Records</h3>
            <form method="POST" class="search-form">
                <div class="form-group">
                    ...
                    <select name="search_type" id="search_type" required>
                        ...
                        <option value="candidate_id" <?php echo ($searchType === 'candidate_id') ? 'selected' : ''; ?>>Candidate ID</option>
                ...
                <button type="submit" name="search" class="action-btn teveta-btn">
                ...
                <?php else: ?>
                    ...
                    <div class="records-grid">
                        <?php foreach ($searchResults['records'] as $record): ?>
                            <div class="record-card teveta-record" data-record-id="<?php echo $record['id']; ?>">
                                ...
                                <div class="record-details">
                                    <div class="detail-row">
                                        ...
                                        <span class="value"><?php echo htmlspecialchars($record['candidate_id']); ?></span>
                                    </div>
                                    <div class="detail-row">
                                    ...
                                    <div class="detail-row">
                                        ...
                                        <span class="value"><?php echo htmlspecialchars($record['programme']); ?></span>
                                    </div>
                                    <?php if (!empty($record['level'])): ?>
                                        <div class="detail-row">
                                            <span class="label">Level:</span>
                                            <span class="value"><?php echo htmlspecialchars($record['level']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($record['trade_code'])): ?>
                                        <div class="detail-row">
                                            <span class="label">Trade Code:</span>
                                            <span class="value"><?php echo htmlspecialchars($record['trade_code']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <div class="detail-row">
                                    ...
                                    <?php endif; ?>
                                    <?php if (!empty($record['sub_institution'])): ?>
                                        <div class="detail-row">
                                            <span class="label">Sub Institution:</span>
                                            <span class="value"><?php echo htmlspecialchars($record['sub_institution']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>

                                <div class="record-footer">
                                    <small>Record ID: <?php echo $record['id']; ?> | Added: <?php echo date('d M Y', strtotime($record['created_at'])); ?></small>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
        ...
        <div class="dashboard-card">
            ...
            <div class="quick-actions">
                ...
                <a href="view_he_record.php" class="action-btn he-btn">
...
<script src="../../../../assets/js/teveta-records.js"></script>
